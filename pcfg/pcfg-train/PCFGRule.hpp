...
//        	std::cout << "PCFGRule: Rule for '" << *this << "' successfully created.";
        } else {
...
//                	std::cout << "PCFGRule: missing arrow in rule '" << s << "'";
                    return false;
                } else if (vtokens[0] == "-->" || vtokens[0] == "->") {
//                    LOG(ERROR) << "PCFGRule: missing left-hand side in rule '" << s << "'";
//                	std::cout << "PCFGRule: missing left-hand side in rule '" << s << "'";
                    return false;
                }
...
//                	std::cout << "PCFGRule: missing probability in '" << s << "' Setting value to 1. This may lead to an invalid PCFG.";
                    prob = 1;
                } else {
...
//            	std::cout << "PCFGRule: Too few components in rule '" << s << "'";
                return false;
            }
...
//        	std::cout << "PCFGRule: No valid signature given for rule '" << s << "'";
            return false;
        }
