...
//    	std::cout << "InsideOutsideCalculator: Calculating Inside Probability: '" << signature.resolve_id(symbol) << "'(" << (unsigned)begin << ", " << (unsigned)end << ")";
...
//        	std::cout << "InsideOutsideCalculator: Using cached Inside Probability (" << *cached_prob << ") for '" << signature.resolve_id(symbol) << "'(" << (unsigned) begin << ", " << (unsigned) end << ")";
...
//                    	std::cout << "InsideOutsideCalculator: Inside Probability: is '" << rule->get_prob() << "' for " << signature.resolve_id(symbol) << "'(" << (unsigned) begin << ", " << (unsigned) end << ")";
...
//            	std::cout << "InsideOutsideCalculator: Inside Probability: is '0' for " << signature.resolve_id(symbol) << "'(" << (unsigned) begin << ", " << (unsigned) end << ")";
...
//        std::cout << "InsideOutsideCalculator: Inside Probability: is '" << score << "' for " << signature.resolve_id(symbol) << "'(" << (unsigned) begin << ", " << (unsigned) end << ")";
...
//    	std::cout << "InsideOutsideCalculator: Calculating Outside Probability: '" << signature.resolve_id(symbol) << "'(" << (unsigned) left << ", " << (unsigned) right << ")";
...
//        	std::cout << "InsideOutsideCalculator: Using cached Outside Probability (" << *cached_prob << ") for '" << signature.resolve_id(symbol) << "'(" << (unsigned) left << ", " << (unsigned) right << ")";
            return *cached_prob;
        }
...
//            	std::cout << "InsideOutsideCalculator: Outside probability  is '1' for '" << signature.resolve_id(symbol) << "'(" << (unsigned) left << ", " << (unsigned) right << ")";
...
//            	std::cout << "InsideOutsideCalculator: Outside probability  is '0' for '" << signature.resolve_id(symbol) << "'(" << (unsigned) left << ", " << (unsigned) right << ")";
...
//            	std::cout << "InsideOutsideCalculator: Current rule: '" << **rule << "' with '" << signature.resolve_id(symbol) << "' as first symbol on the rhs.'";
...
//        	std::cout << "InsideOutsideCalculator: No rule with '" << signature.resolve_id(symbol) << "' as first symbol on the rhs exists.'";
        }
...
//        std::cout << "InsideOutsideCalculator: Outside probability for the left child is '" << score_left << "' for '" << signature.resolve_id(symbol) << "'(" << (unsigned) left << ", " << (unsigned) right << ")";
...
//            	std::cout << "InsideOutsideCalculator: Current rule: '" << **rule << "' with '" << signature.resolve_id(symbol) << "' as second symbol on the rhs.'";
...
//        	std::cout << "InsideOutsideCalculator: No rule with '" << signature.resolve_id(symbol) << "' as second symbol on the rhs exists.'";
        }
...
//        std::cout << "InsideOutsideCalculator: Outside probability for the right child is '" << score_right << "' for '" << signature.resolve_id(symbol) << "'(" << (unsigned) left << ", " << (unsigned) right << ")";
...
//        std::cout << "InsideOutsideCalculator: Outside probability  is '" << score_left + score_right << "' for '" << signature.resolve_id(symbol) << "'(" << (unsigned) left << ", " << (unsigned) right << ")";
